...
### 🚀 Major Features
- **Tier 5 Integration**: Added support for `gpt-5.1-high` (Creative/Reasoning) and `gpt-5.1-codex` (Engineering).
...
### 🛠️ Improvements
- **Unified Port**: Standardized entire application on port `8087`.
